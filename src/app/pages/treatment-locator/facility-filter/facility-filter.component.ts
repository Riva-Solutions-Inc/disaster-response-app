...
import { AInANLanguages, otherLanguages } from '../data';
...
export class FacilityFilterComponent implements OnInit {
  ...
  AInANLanguages = AInANLanguages;
  otherLanguages = otherLanguages;
  sLanguages2Length = 12;
  sLanguages3Length = 12;

  constructor(private modalController: ModalController, private zone: NgZone, private alertService: AlertService, private localstorage: LocalStorageService) {}
  ...
  showAllS3Language() {
    this.filter.sLanguages3.length === this.sLanguages3Length ? (this.sLanguages3Length = 12) : (this.sLanguages3Length = this.filter.sLanguages3.length);
  }
  /**
